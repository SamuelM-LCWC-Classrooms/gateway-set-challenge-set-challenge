def task(): # Hint - you may need to create new, mid-point sets for the individuals, then combine them
    ...
    duplicate_fruits = {"banana", "cherry", "grape", "mango", "papaya", "lemon"} # This should be a tuple containing all the fruits in both tuples
    individual_fruits = {"apple", "raspberry", "blueberry", "pineapple", "orange"} # This should be a tuple containing only the individual fruits
